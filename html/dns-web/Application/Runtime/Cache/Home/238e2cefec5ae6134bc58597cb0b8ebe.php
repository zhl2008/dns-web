...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/dns-web/Public/css/bootstrap.css" rel="stylesheet">
...
<body>
                        ...
                        <form role="form" method="post" action="#">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Usename" name="uname" type="username" autofocus>
                                </div>
                                <div class="form-group">
    ...
    <!-- jQuery -->
    <script src="/dns-web/Public/js/jquery.min.js"></script>
